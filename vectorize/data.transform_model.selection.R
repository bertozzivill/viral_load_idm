...
main_dir <- "C:/Users/abertozz/Dropbox (IDM)/viral_load/cascade/data/cross_validation/1/1/"
  ...
  #data=data.for.survival[modelselection$bestmodel.min.Rubin.error[1]][[1]] #does this line work??
  ...
  ###FIGURE 3c
  source("plot.modelcurve.R")
  plot.modelcurve(bestmodel,modelnames[modelselection$min.Rubin.error[1]],'title')
  
  #NOTE: I'm commenting out everything below this line because I don't have access to the function sources below, and the code breaks because
  # it can't find the element "bestmodel.names".
  # source('c:/Users/cselinger/TOOLS/multiplot.R') #is there a difference between this "multiplot" and the one in the "vectorize" folder?
